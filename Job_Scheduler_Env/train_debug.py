#!/usr/bin/env python3
"""
Debug script to test environment and action parsing.
Run this FIRST to verify everything works before training.
"""
...
async def test_environment():
    """Test if environment works and gives non-constant rewards."""
    print("=" * 60)
    print("Testing Job Scheduler Environment")
    print("=" * 60)
...
if __name__ == "__main__":
    print("Start the OpenEnv server first:")
    print("  uvicorn Job_Scheduler_Env.server.app:app --reload --port 8000")
    print()
